...
use App\Filament\AccountsPanel\Resources\IncomeResource\Pages;
use App\Filament\AccountsPanel\Resources\IncomeResource\RelationManagers;
        ...
        return $form
            ->schema([
                ...
                Forms\Components\TextInput::make('amount')
                    ->required()
                    ->maxLength(255),
                Forms\Components\TextInput::make('incometype_id')
                    ->required()
                    ->numeric(),
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('amount')
                    ->searchable(),
                Tables\Columns\TextColumn::make('incometype_id')
                    ->numeric()
                    ->sortable(),
